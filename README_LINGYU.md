...
该仓库包含开源模型和用于微调训练的软件包，该代码仓库基于 [openpi](https://github.com/Physical-Intelligence/openpi)。

提供一个基础 VLA 模型权重，用于微调训练。 

| 基础模型        | 用途    | 描述                                                                                                 | 检查点路径                                |
| ------------ | ----------- | ----------------------------------------------------------------------------------------------------------- | ---------------------------------------------- |
| $\pi_0$      | 微调 | 用于微调的 [π₀ 模型](https://www.physicalintelligence.company/blog/pi0)                | `gs://openpi-assets/checkpoints/pi0_base`      |
